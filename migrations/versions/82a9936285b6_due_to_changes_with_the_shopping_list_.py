"""Due to changes with the Shopping List table and complications in creating a migration with these updates, I have had to re-initialise the database from scratch (losing the 5 versions we had previously created in migrations)

Revision ID: 82a9936285b6
Revises: 
Create Date: 2026-05-12 14:17:01.983564
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('user_id', 'recipe_id', name='uq_shopping_list_user_recipe')
    )
