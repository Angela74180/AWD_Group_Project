...
function addIngredient(ingredientDict) {
    ...
    newIngredient.innerHTML = `
        ...
        <input name="ingredientQuantity" type = "number" style="width: 100px; margin-bottom: 2%" min = "0" placeholder = "Quantity (e.g 750, 0.25)" value = "${ingredientDict["quantity"]}" required>
